# BuildWise — Sample Backend CRUD Reference

> **File name:** `BuildWise_Sample_Backend_CRUD.md`
>
> **Purpose:** Canonical sample CRUD implementation for BuildWise backend development.
>
> **Example feature:** `Projects`
>
> **Stack:** NestJS + TypeScript + Zod + PostgreSQL + Drizzle ORM
>
> This sample follows the BuildWise backend standards:
>
> - thin controllers
...
In the real BuildWise application, environment values should be validated centrally during startup rather than validated independently here.
  ...
  implements ExceptionFilter
{
    ...
    if (exception instanceof AppError) {
      response
        ...
        .json({
          type:
            `https://buildwise.example/problems/` +
            exception.code
              .toLowerCase()
              .replaceAll("_", "-"),
    ...
    response
      ...
      .json({
        type:
          "https://buildwise.example/problems/internal-error",
        title:
...
For BuildWise production, project deletion may eventually become:
...
```http
PATCH /api/v1/projects/project_1
Content-Type: application/json
```
...
```http
DELETE /api/v1/projects/project_1
```
...
This is the reference CRUD architecture BuildWise should use for normal SaaS resources.
